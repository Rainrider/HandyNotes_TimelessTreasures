...
local moss = "Moss-Covered Chest"
local sturdy = "Sturdy Chest"
local smoldering = "Smoldering Chest"
local skull = "Skull-Covered Chest"
local blazing = "Blazing Chest"
...
points["TimelessIsle"] = {
	...
	[24623863] = {type = moss, quest = 33200, note = "On a treestump"},
	[24755301] = {type = moss, quest = 33176},
	[25522721] = {type = moss, quest = 33171},
	[25664584] = {type = moss, quest = 33177},
	[26016145] = {type = moss, quest = 33199, note = "On a treestump"},
	[26856875] = {type = moss, quest = 33179},
	[27363909] = {type = moss, quest = 33172},
	[29683174] = {type = moss, quest = 33202, note = "On the ramp"},
	[30603655] = {type = moss, quest = 33173, note = "On a treestump"},
	...
	[44136546] = {type = moss, quest = 33198, note = "On a treestump"},
	[46764678] = {type = moss, quest = 33187},
	[46955369] = {type = moss, quest = 33186},
	[49716572] = {type = moss, quest = 33195},
	[51174568] = {type = moss, quest = 33188, note = "In the slump scraps under the broken bridge"},
	...
	[61648849] = {type = moss, quest = 33227, note = "In the shipwreck of Cpt. Zvezdan"},
	[63815915] = {type = moss, quest = 33192},
	[64917559] = {type = moss, quest = 33193},
	[65634783] = {type = moss, quest = 33191},
	-- Sturdy Chests
	[26676495] = {type = sturdy, quest = 33205, note = "On the top of the cliff. Use the Highwind Albatross"},
	[28193521] = {type = sturdy, quest = 33204, note = "On the top of the cliff. Use the Highwind Albatross"},
	[59254946] = {type = sturdy, quest = 33207, note = "Inside the Mysterious Den. Use one of objects from Legends of the Past"},
	[64687047] = {type = sturdy, quest = 33206},
	-- Smoldering Chests
	[53987805] = {type = smoldering, quest = 33209},
	[69573289] = {type = smoldering, quest = 33208},
	-- Skull-Covered Chest
	[46703230] = {type = skull, quest = 33203, note = "Inside Cavern of Lost Spirits (entrance at 43.2, 41.3)"},
	-- Blazing Chest
...
function TimelessTreasures:OnEnter(mapFile, coord)
	...
	tooltip:AddLine("Note: " .. (info.note or ""), 1, 1, 1, true)
	tooltip:Show()
end
...
local options = {
	...
	desc = "Timeless Treasures locations.",
	...
	args = {
		...
		completed = {
			name = "Show completed",
			desc = "Show icons for treasures you have already got.",
			type = "toggle",
			width = "full",
			arg = "completed",
			order = 2,
